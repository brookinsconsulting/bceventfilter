...
{set-block scope=root variable=email_receiver}info@brookinsconsulting.com{/set-block}

{def $results_receiver_email='brookinsconsulting@gmail.com'}
{set-block scope=root variable=email_receiver}{$results_receiver_email}{/set-block}
*}

{set-block scope=root variable=email_receiver}brookinsconsulting@gmail.com{/set-block}

{* Set this to redirect to another node
{set-block scope=root variable=redirect_to_node_id}2{/set-block}
*}
{set-block scope=root variable=redirect_to_node_id}172{/set-block}
